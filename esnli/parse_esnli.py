...
if os.path.exists(args.path_esnli_train_1) is False and args.split == 'train':
    os.system('wget https://github.com/OanaMariaCamburu/e-SNLI/raw/master/dataset/esnli_train_1.csv')
    os.system('wget https://github.com/OanaMariaCamburu/e-SNLI/raw/master/dataset/esnli_train_2.csv')

if os.path.exists(args.path_esnli_dev) is False and args.split == 'dev':
    os.system('wget https://github.com/OanaMariaCamburu/e-SNLI/raw/master/dataset/esnli_dev.csv')

if os.path.exists(args.path_esnli_test) is False and args.split == 'test':
    os.system('wget https://github.com/OanaMariaCamburu/e-SNLI/raw/master/dataset/esnli_test.csv')
