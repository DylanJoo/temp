...
# ============================= msmarco  ================================
MixtureRegistry.remove("msmarco_passage_ranking_multiview_0.15")
MixtureRegistry.add(
    "msmarco_passage_ranking_multiview_0.15",
    [("msmarco_passage_ranking", 0.85), ("msmarco_passage_to_query", 0.15)]
    )
