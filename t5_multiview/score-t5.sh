for ITER in {00..20}; do
  echo "Running iter: $ITER" >> process-t5.out
  nohup t5_mesh_transformer \
    --tpu="tpu-pr2" \
    --gcp_project="trec-cast-322304" \
    --tpu_zone="europe-west4-a" \
    --model_dir="gs://conversational-ir/pr-pointwise_ranking/models/large" \
    ...
    --gin_param="scores_filename = 'gs://conversational-ir/treccast/data/passage_reranking/autocano_official/score/t5_query_passage_relevance.txt$ITER'" \
