...
from t5.data.msmarco import msmarco_passage_ranking_ds, msmarco_passage_to_query_ds, msmarco_passage_ranking_prep, msmarco_passage_to_query_prep
...
# Passage Ranking task via triplet dataset
TaskRegistry.add(
...
# Passage to query task via query passage relevant pair
TaskRegistry.add(
